...
description: "60% of UK dogs are distressed by fireworks. Expert-backed techniques, proven products, and preparation tips to keep your dog safe and calm."
...
*Fireworks season doesn't have to mean misery for your four-legged friend. Here's everything you need to know about keeping your dog calm, safe, and stress-free — from proven products to expert-backed techniques.*
...
|-------|--------------|-----------|
| **Bonfire Night** | Oct 31 – Nov 7 | 🔴 Peak season |
| **Diwali** | Oct/Nov (varies) | 🟡 Moderate |
| **New Year's Eve** | Dec 31 – Jan 1 | 🟡 Moderate |
| **Wedding season** | May – September | 🟢 Sporadic |
| **Local events** | Year-round | 🟢 Sporadic |
...
- ADAPTIL Calm Home Diffuser (covers ~70m²) — **~£25-30**
...
➡️ [Check price on Amazon](https://www.amazon.co.uk/s?k=ADAPTIL+calm+diffuser) | Also available from your vet or Pets at Home
...
- ThunderShirt Classic — **~£35-45** (sizing from XXS to XXL)
...
➡️ [Check price on Amazon](https://www.amazon.co.uk/s?k=ThunderShirt+dog) | Also from Pets at Home, ADAPTIL.co.uk
...
- YuMOVE Calming Care for Dogs — **~£15-20** (30 tablets)
...
➡️ [Check price on Amazon](https://www.amazon.co.uk/s?k=YuMOVE+calming+care+dog) | Also from YuMOVE.co.uk direct

### Other Options Worth Considering

| Product | Type | Price | Notes |
|---------|------|-------|-------|
| **Dorwest Scullcap & Valerian** | Herbal tablets | ~£12 | Popular UK herbal remedy, give 30 mins before |
| **Pet Remedy Diffuser** | Plug-in diffuser | ~£15 | Valerian-based, works for cats too |
| **Kong Classic (stuffed & frozen)** | Distraction | ~£8-15 | Not "calming" per se, but occupation = less panic |
| **Snuffle mat** | Enrichment | ~£10-20 | Mental stimulation to redirect focus |
...
- Many offer remote consultations — expect to pay £100-250 for an initial session
...
**Campaigning for change:** The RSPCA and many animal charities are pushing for stricter regulations, including mandatory "quiet fireworks" and advanced notice requirements. Visit [rspca.org.uk/fireworks](https://www.rspca.org.uk/fireworks) to support the campaign.
